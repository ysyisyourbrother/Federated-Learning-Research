...
GRPC_IP_CONFIG_FILE="./experiment/fedprox/grpc_ipconfig.csv"
CHECKPOINT_PATH="./checkpoint/fedprox"
CLIENT_CONFIG_PATH="./experiment/fedprox/client_config.yaml"
...
python3 ./fedprox/main_fedprox_distributed.py \
  --model $MODEL \
  --dataset $DATASET \
  --data_dir $DATA_DIR \
