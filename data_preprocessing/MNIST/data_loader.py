...
def main(root_dir, user_data_class, client_num, num_split):
    ...
    trainset = torchvision.datasets.MNIST(os.path.join(root_dir,"train"), download=True, train=True)
    testset = torchvision.datasets.MNIST(os.path.join(root_dir,"test"), download=True, train=False)
...
def load_partition_data_mnist(data_dir, client_num, user_data_class, batch_size):
...
if __name__ == '__main__':
    load_partition_data_mnist("./data/MNIST", 100, 2, 32)