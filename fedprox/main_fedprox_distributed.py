...
from fedprox.FedProxAPI import FedML_FedProx_distributed
...
def add_args(parser):
    ...
    parser.add_argument('--checkpoint_path', type=str, default="./checkpoint/fedprox/",
                        help='Path to store checkpoints')

    parser.add_argument('--client_config_path', type=str, default="./experiment/fedprox/group_config.yaml",
...
if __name__ == "__main__":
    ...
    FedML_FedProx_distributed(args.fl_worker_index, device, None,
