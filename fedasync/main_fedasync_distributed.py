...
from fedasync.FedAsyncAPI import FedML_FedAsync_distributed
...
def add_args(parser):
    ...
    parser.add_argument('--user_data_class', type=int, default=2, metavar='PA',
    ...
    parser.add_argument('--checkpoint_path', type=str, default="./checkpoint/fedasync/",
                        help='Path to store checkpoints')

    parser.add_argument('--client_config_path', type=str, default="./experiment/fedasync/group_config.yaml",
    ...
    parser.add_argument('--aggregate_alpha', type=float, default=0.6,
                        help='weight param used in FedAsync aggregation, default is 0.6.')
...
if __name__ == "__main__":
    ...
    FedML_FedAsync_distributed(args.fl_worker_index, device, None,
